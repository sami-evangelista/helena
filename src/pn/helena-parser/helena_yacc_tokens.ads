   ...
   type Element_Record(T : Element_Type) is record
    ...
    type Token is
        (End_Of_Input, Error, Assert_Token, And_Token,
         ...
         Proposition_Token, Range_Token, Return_Token,
         Safe_Token, Set_Token, Struct_Token,
         Subtype_Token, Succ_Token, Sum_Token,
         Transition_Token, Type_Token, Vector_Token,
         While_Token, With_Token, Identifier_Token,
         Number_Token, String_Token, Amp_Token,
         Comma_Token, Div_Token, Dot_Dot_Token,
         Dot_Token, Eq_Token, Implies_Token,
         Inf_Token, Inf_Eq_Token, Lbrace_Token,
         Lbracket_Token, Lhook_Token, Ltuple_Token,
         Minus_Token, Neq_Token, Pipe_Token,
         Plus_Token, Question_Token, Quote_Token,
         Rbrace_Token, Rarrow_Token, Rbracket_Token,
         Rhook_Token, Rtuple_Token, Semicolon_Token,
         Sup_Token, Sup_Eq_Token, Times_Token,
         Colon_Token, Colon_Colon_Token, Colon_Equal_Token );
